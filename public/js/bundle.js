...
exports.updateUserData = exports.updatePassword = exports.logout = exports.login = void 0;
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(oldPassword, newPassword, newPasswordConfirm) {
    var res;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe("pk_test_51MQiTdHdpPhRIKKWKS8bzAP7QcJHnbcqNmCzH9SK64ifDGAZFzIGTZIxEOmIoXIOs5MiUrhlFZqtpA6YGK2PqNrL00HGYrQEpd");
...
if (loginForm) {
  loginForm.addEventListener("submit", function (e) {
    ...
    (0, _auth.login)(email, password).then(function (res) {
...
if (logoutBtn) {
  logoutBtn.addEventListener("click", function (e) {
    (0, _auth.logout)().then(function (res) {
      (0, _alerts.showAlert)("success", res.data.message);
      setTimeout(function () {
        window.location.replace("/");
      }, 1500);
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var oldPassword, newPassword, newPasswordConfirm, res;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            ...
            _context.prev = 5;
            _context.next = 8;
            return (0, _auth.updatePassword)(oldPassword, newPassword, newPasswordConfirm);
          case 8:
            res = _context.sent;
            (0, _alerts.showAlert)("success", res.data.message);
            _context.next = 15;
          ...
          case 12:
            ...
            (0, _alerts.showAlert)("error", _context.t0.response.data.errors[0].msg);
          case 15:
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11690" + '/');
